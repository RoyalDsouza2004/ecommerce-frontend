  ...
  return (
    <div
      className="
        ...
        flex-shrink-0 border border-gray-300
      "
    >
      {/* Image */}
      <div className="w-full h-48 flex justify-center items-center bg-gray-50 rounded-t-md overflow-hidden">
        <img
      ...
      <div className="flex flex-col items-center justify-end flex-grow px-2 pb-4">
        <p className="mt-2 text-center font-medium text-sm sm:text-base truncate w-full">
          {name}
        </p>
